...
def run_ocr_batch(
    ...
    """Run OCR on a batch of entities (pipeline stage)."""
    return run_batch_stage_task(self, previous_result, EntityType(entity_type), OCRProcessor)


ProcessorRegistry.set_batch_task(OCRProcessor.NAME, run_ocr_batch)
